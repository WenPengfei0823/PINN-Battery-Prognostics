...
for l in range(len(inputs_lib_dynamical)):
    ...
    for round in range(num_rounds):
        ...
        torch.save(weights_rounds, '..\\..\\Results\\3 Adaptive Balancing\\weights_rounds_SoH_CaseB_DeepHPM_AdpBal.pth')
    ...
    torch.save(metric_mean, '..\\..\\Results\\3 Adaptive Balancing\\metric_mean_SoH_CaseB_DeepHPM_AdpBal.pth')
    torch.save(metric_std, '..\\..\\Results\\3 Adaptive Balancing\\metric_std_SoH_CaseB_DeepHPM_AdpBal.pth')
...
scipy.io.savemat('..\\..\\Results\\3 Adaptive Balancing\\SeversonBattery_CaseB_DeepHPM_AdpBal.mat', CapacityNNOutputs)
pass
