...
for l in range(len(inputs_lib_dynamical)):
    ...
    torch.save(metric_mean, '..\\..\\Results\\3 Adaptive Balancing\\metric_mean_RUL_CaseA_DeepHPM_AdpBal.pth')
    torch.save(metric_std, '..\\..\\Results\\3 Adaptive Balancing\\metric_std_RUL_CaseA_DeepHPM_AdpBal.pth')
