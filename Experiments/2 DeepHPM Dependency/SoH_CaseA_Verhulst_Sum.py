...
for round in range(num_rounds):
    ...
    torch.save(metric_mean, '..\\..\\Results\\2 DeepHPM Dependency\\metric_mean_SoH_CaseA_Verhulst_Sum.pth')
    torch.save(metric_std, '..\\..\\Results\\2 DeepHPM Dependency\\metric_std_SoH_CaseA_Verhulst_Sum.pth')
...
scipy.io.savemat('..\\..\\Results\\2 DeepHPM Dependency\\SeversonBattery_CaseA_Verhulst_Sum.mat', CapacityNNOutputs)
pass
