...
for l in range(len(inputs_lib_dynamical)):
    ...
    for round in range(num_rounds):
        ...
        torch.save(metric_mean, '..\\..\\Results\\2 DeepHPM Dependency\\metric_mean_RUL_CaseB_DeepHPM_Sum..pth')
        torch.save(metric_std, '..\\..\\Results\\2 DeepHPM Dependency\\metric_std_RUL_CaseB_DeepHPM_Sum..pth')
