...
for l in range(len(inputs_lib_dynamical)):
    ...
    for round in range(num_rounds):
        ...
        torch.save(metric_mean, '..\\..\\Results\\2 DeepHPM Dependency\\metric_mean_SoH_CaseB_DeepHPM_Sum.pth')
        torch.save(metric_std, '..\\..\\Results\\2 DeepHPM Dependency\\metric_std_SoH_CaseB_DeepHPM_Sum.pth')
...
scipy.io.savemat('..\\..\\Results\\2 DeepHPM Dependency\\SeversonBattery_CaseB_DeepHPM_Sum.mat', CapacityNNOutputs)
pass
